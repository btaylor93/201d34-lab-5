...
function sum(a, b) { //eslint-disable-line
  var returnNumber = a + b;
  var returnString = 'The sum of ' + a + ' and ' + b + ' is ' + returnNumber + '.';
...
function multiply(a, b) { //eslint-disable-line
  var returnNumber = a * b;
  var returnString = 'The product of ' + a + ' and ' + b + ' is ' + returnNumber + '.';
  return [returnNumber,returnString];
}
...
function sumAndMultiply(a, b, c) { //eslint-disable-line
  ...
  var returnSumString = a + ' and ' + b + ' and ' + c + ' sum to ' + returnSum + '.';
  var returnProductString = 'The product of ' + a + ' and ' + b + ' and ' + c + ' is ' + returnProduct + '.';
...
function sumArray(sumArr) { //eslint-disable-line
  ...
  for (var i in sumArr){
    returnNumber = sum(returnNumber, sumArr[i])[0];
    returnString += sumArr[i];
    if (i < sumArr.length - 1){
      returnString += ',';
    }
  }

  returnString += ' was passed in as an array of numbers, and ' + returnNumber + ' is their sum.';
...
function multiplyArray(multArr) { //eslint-disable-line
  ...
  for (var i in multArr) {
    returnNumber = multiply(returnNumber, multArr[i])[0];
    returnString += multArr[i];
    if (i < multArr.length - 1) {
      returnString += ',';
    }
  }

  returnString += ' have a product of ' + returnNumber + '.';
